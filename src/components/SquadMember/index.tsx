    ...
    return (
        <div className="card shadow--md margin--md">
            <div className="card__image">
                <a href={`/squadx/docs/squad/${id}`}><img src={`/squadx${image}`} alt={`${name}'s picture`} /></a>
            </div>
            ...
            <div className="card__footer">
                <a href={`/squadx/docs/squad/${id}`} className="button button--block button--secondary">More</a>
            </div>
        </div>
    );
};
